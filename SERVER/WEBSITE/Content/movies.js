...
movieObjects = {
    ...
    {
        contentID:"Avatar_2",
        contentTitle:"Avatar: The Way of Water",
        readableDescription:[
    ...
    "The_Big_Short":
    {
        contentID:"The_Big_Short",
        contentTitle:"The Big Short",
        readableDescription:[
            ".",
        ],
        fileType:"mp4",
    ...
    {
        contentID:"The_Wolf_Of_Wall_Street",
    ...
    "Iron_Man_1":
    {
        contentID:"Iron_Man_1",
        contentTitle:"Iron Man",
        readableDescription:[
            ".",
        ],
        fileType:"mp4",
    ...
    "Iron_Man_2":
    {
        contentID:"Iron_Man_2",
        contentTitle:"Iron Man 2",
        readableDescription:[
            ".",
        ],
        fileType:"mp4",
    ...
    {
        contentID:"Thor_2",
        contentTitle:"Thor: The Dark World",
        readableDescription:[
            ".",
        ],
        fileType:"mp4",
    ...
    {
        contentID:"Thor_4",
        contentTitle:"Thor: Love and Thunder",
        readableDescription:[
            ".",
        ],
        fileType:"mp4",
    ...
    "Avengers_2":
    {
        contentID:"Avengers_2",
        contentTitle:"Avengers: Age of Ultron",
        readableDescription:[
            ".",
        ],
        fileType:"mp4",
    ...
    "Avengers_3":
    {
        contentID:"Avengers_3",
        contentTitle:"Avengers: Infinity War",
        readableDescription:[
            ".",
        ],
        fileType:"mp4",
    ...
    {
        contentID:"Guardians_Of_The_Galaxy_1",
        contentTitle:"Guardians of The Galaxy",
        readableDescription:[
            ".",
        ],
        fileType:"mp4",
    ...
    {
        contentID:"Guardians_Of_The_Galaxy_2",
        contentTitle:"Guardians of The Galaxy Vol. 2",
        readableDescription:[
            ".",
        ],
        fileType:"mp4",
    ...
    {
        contentID:"Guardians_Of_The_Galaxy_3",
        contentTitle:"Guardians of The Galaxy Vol. 3",
        readableDescription:[
            ".",
        ],
        fileType:"mp4",
    ...
    "Spiderman_Toby_2":
    {
        contentID:"Spiderman_Toby_2",
        contentTitle:"Spiderman 2",
        readableDescription:[
            ".",
        ],
        fileType:"mp4",
    ...
    "Spiderman_Toby_3":
    {
        contentID:"Spiderman_Toby_3",
        contentTitle:"Spiderman 3",
        readableDescription:[
            ".",
        ],
        fileType:"mp4",
    ...
    "Spiderman_Andrew_1":
    {
        contentID:"Spiderman_Andrew_1",
        contentTitle:"The Amazing Spiderman",
        readableDescription:[
            ".",
        ],
        fileType:"mp4",
    ...
    "Spiderman_Andrew_2":
    {
        ...
        contentTitle:"The Amazing Spiderman 2",
        readableDescription:[
            ".",
        ],
        fileType:"mp4",
    ...
    "Captain_America_2":
    {
        contentID:"Captain_America_2",
        contentTitle:"Captain America: The Winter Soldier",
        readableDescription:[
            ".",
        ],
        fileType:"mp4",
    ...
    "Captain_America_3":
    {
        contentID:"Captain_America_3",
        contentTitle:"Captain America: Civil War",
        readableDescription:[
            ".",
        ],
        fileType:"mp4",
    ...
    {
        contentID:"Ant_Man_3",
        contentTitle:"Ant Man & The Wasp: Quantumania",
        readableDescription:[
            ".",
        ],
        fileType:"mp4",
    ...
    "Black_Widow_1":
    {
        contentID:"Black_Widow_1",
        contentTitle:"Black Widow",
        readableDescription:[
            ".",
        ],
        fileType:"mp4",
    ...
    "The_Hulk_1":
    {
        contentID:"The_Hulk_1",
        contentTitle:"The Incredible Hulk",
        readableDescription:[
            ".",
        ],
        fileType:"mp4",
